...
public class ConstrainedGraphPartitioning
{
	 ...
	 * @return a partitioning of the basic graph G that is isomorphic to the constraint graph C.
	 */
	static GraphPartitioningState partitionConstrainedWithCoarsening(SearchConfiguration sc,Random rand,int afterCoarseningSize, int maxNodesExpanded )
	{
		if(afterCoarseningSize != -1)
	 ...
	 * <b>We suggested</b> to find an appropriate value for the new size (afterCoarseningSize or k) and then use one the of the implementations of partitionWithCoarseningAndRandomRestart() to fight the sensitivity to the initial state instead of this method.<br/>
	 ...
	 * @return a partitioning of the basic graph G that is isomorphic to the constraint graph C.
	 */
	static GraphPartitioningState partitionConstrainedWithIterativeCoarsening(SearchConfiguration sc,Random rand, int afterCoarseningInitialSize ,int coarseningIncreament, int maxNodesExpanded)
	{
		int GSize = GraphUtil.sizeOf(sc.getBasicGraph());
	 ...
	 * @return a partitioning of the basic graph G that is isomorphic to the constraint graph C.
	 */
	static GraphPartitioningState partitionConstrained(SearchConfiguration sc,GraphPartitioningState initialState, int maxNodesExpanded)
	{
